...
CSV — це текстовий формат для зберігання табличних даних, в якому рядки розділяються переносами рядків, а поля — комами. У цій роботі він потрібен для зберігання товарів і подальшої автоматичної обробки без бази даних.
